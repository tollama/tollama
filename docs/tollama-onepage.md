...
| 제공 인터페이스 | 설명 |
|---------------|------|
| **HTTP API** | 예측, 비교, 분석, 리포트, 대시보드, XAI까지 한 데몬에서 제공 |
| **Python SDK** | `Tollama` 클래스, DataFrame 변환, 체이닝 workflow |
...
| 연동 경로 | 설명 |
|----------|------|
| **MCP Server** | 22개 도구 — forecast/orchestration 15개 + XAI/trust 7개 |
...
├────────────────────────────────────────────────────────┤
│  AI 에이전트: MCP (22 tools) / A2A / LangChain / ...   │
├────────────────────────────────────────────────────────┤
