"""Optional integration coverage for real Sundial forecasting."""
...
def test_sundial_forecast_integration(monkeypatch, tmp_path) -> None:
    ...
    with TestClient(create_app()) as client:
        pull_response = client.post(
            "/api/pull",
            json={"model": "sundial-base-128m", "stream": False},
        )
    ...
    assert len(body["forecasts"][0]["mean"]) == 4
