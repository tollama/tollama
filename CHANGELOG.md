...
- macOS Data tab CSV scanning and preview no longer block on counting every row
  in large files, and wide weather/electricity-style CSV previews render a
  bounded fixed cell grid with UTF-8, Windows-1252, and Latin-1 text decoding
