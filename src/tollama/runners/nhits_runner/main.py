"""N-HiTS runner process over stdio JSON-RPC."""
...
def _handle_unload(request: ProtocolRequest, adapter: NhitsAdapter) -> ProtocolResponse:
...
def _handle_forecast(request: ProtocolRequest, adapter: NhitsAdapter) -> ProtocolResponse:
    canonical_params = {
