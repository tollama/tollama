"""Toto runner process using newline-delimited JSON over stdio."""
...
def _handle_hello(request: ProtocolRequest) -> ProtocolResponse:
    return ProtocolResponse(
        ...
        result={
            ...
            "supported_families": ["toto"],
        },
    )


def _handle_unload(request: ProtocolRequest, adapter: TotoAdapter) -> ProtocolResponse:
...
def _handle_forecast(request: ProtocolRequest, adapter: TotoAdapter) -> ProtocolResponse:
    canonical_params = {
...
def handle_request_line(line: str | bytes, adapter: TotoAdapter) -> ProtocolResponse:
