"""TimesFM runner process using newline-delimited JSON over stdio."""
...
def _handle_hello(request: ProtocolRequest) -> ProtocolResponse:
    return ProtocolResponse(
        ...
        result={
            ...
            "supported_families": ["timesfm"],
        },
    )


def _handle_unload(request: ProtocolRequest, adapter: TimesFMAdapter) -> ProtocolResponse:
...
def _handle_forecast(request: ProtocolRequest, adapter: TimesFMAdapter) -> ProtocolResponse:
    canonical_params = {
...
def handle_request_line(line: str | bytes, adapter: TimesFMAdapter) -> ProtocolResponse:
