"""Lag-Llama runner process using newline-delimited JSON over stdio."""
...
def _handle_hello(request: ProtocolRequest) -> ProtocolResponse:
    return ProtocolResponse(
        ...
        result={
            ...
            "supported_families": ["lag_llama"],
        },
    )


def _handle_unload(request: ProtocolRequest, adapter: LagLlamaAdapter) -> ProtocolResponse:
...
def _handle_forecast(request: ProtocolRequest, adapter: LagLlamaAdapter) -> ProtocolResponse:
    canonical_params = {
